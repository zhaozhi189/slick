...
import scala.slick.testutil.{DBTest, DBTestObject}
import scala.slick.testutil.TestDBs._
import com.typesafe.slick.testkit.util.JdbcTestDB

object AggWinTest extends DBTestObject(H2Mem)
 ...
 * }
 */
class AggWinTest(val tdb: JdbcTestDB) extends DBTest {
  import tdb.profile.simple._

  @Test def testAggWin: Unit = {
