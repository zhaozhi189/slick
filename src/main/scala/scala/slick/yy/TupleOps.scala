...
trait TupleOps {
  final class YYTuple2[T1, T2](override val _1: TypedNode, override val _2: TypedNode) extends Tuple2(_1, _2) with YYProjection[(T1, T2)]
}

sealed trait YYProjection[T <: Product] extends ProductNode with Product with TypedNode {
